# Development and Testing Guide <br/> Metrics service Microservice Client SDK for Node.js
...
```bash
git clone git@github.com:pip-services-users/pip-clients-email-node.git
```
